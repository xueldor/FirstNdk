...
Square::Square(android_app *pApplication, TimeManager &pTimeManager,
...
void Square::registerSquare(Location &pLocation, int32_t pSizeX, int32_t pSizeY) {
...
void Square::spawn(PhysicsBody* pBody) {

 ...
 * YUV to RGB
 */
JNIEXPORT void JNICALL decode(JNIEnv *pEnv, jobject jthis, jobject pTarget, jbyteArray pSource, jint pFilter){
...
JNIEXPORT jint JNI_OnLoad(JavaVM* pVM, void* reserved) {
    ...
    jclass LiveCameraActivity = (*env)->FindClass(env,"com/xue/livecamera/LiveCameraActivity");
    if (LiveCameraActivity == NULL) abort();
    (*env)->RegisterNatives(env, LiveCameraActivity,gMethodRegistry, gMethodRegistrySize);
